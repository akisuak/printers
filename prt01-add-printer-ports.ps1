...
Add-PrinterPort -Name "5_000_004" -PrinterHostAddress "10.76.34.14"
Add-PrinterPort -Name "5_000_005" -PrinterHostAddress "10.76.34.17"
Add-PrinterPort -Name "5_000_006" -PrinterHostAddress "10.76.34.21"
Add-PrinterPort -Name "5_000_007" -PrinterHostAddress "10.76.34.22"
Add-PrinterPort -Name "5_000_008" -PrinterHostAddress "10.76.34.23"
Add-PrinterPort -Name "5_000_009" -PrinterHostAddress "10.76.34.24"
Add-PrinterPort -Name "5_000_010" -PrinterHostAddress "10.76.34.25"
Add-PrinterPort -Name "5_000_011" -PrinterHostAddress "10.76.34.26"
Add-PrinterPort -Name "5_000_012" -PrinterHostAddress "10.76.34.41"
Add-PrinterPort -Name "5_000_013" -PrinterHostAddress "10.76.34.42"
Add-PrinterPort -Name "5_000_014" -PrinterHostAddress "10.76.34.43"
Add-PrinterPort -Name "5_000_015" -PrinterHostAddress "10.76.34.44"
...
Add-PrinterPort -Name "5_000_025" -PrinterHostAddress "10.76.20.166" # MUS3COLMFP1   
Add-PrinterPort -Name "5_000_026" -PrinterHostAddress "10.76.20.169" # mus1colmfp1
Add-PrinterPort -Name "5_000_027" -PrinterHostAddress "10.76.20.177" # PROF1COLMFP
